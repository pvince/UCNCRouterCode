...
void DL_Dxf::addLayer(DL_CreationInterface* creationInterface) {
    ...
    if (!stricmp(attrib.getLineType().c_str(), "BYLAYER") ||
            !stricmp(attrib.getLineType().c_str(), "BYBLOCK")) {
...
void DL_Dxf::writeLineType(DL_WriterA& dw,
	...
	if (version<VER_2000) {
		if (!stricmp(data.name.c_str(), "BYBLOCK") ||
		    !stricmp(data.name.c_str(), "BYLAYER")) {
			return;
		}
	}
    ...
    } else if (!stricmp(data.name.c_str(), "BYLAYER")) {
        dw.tableLineTypeEntry(0x15);
    } else if (!stricmp(data.name.c_str(), "CONTINUOUS")) {
    ...
    if (!stricmp(data.name.c_str(), "BYBLOCK")) {
        ...
        dw.dxfInt(73, 0);
        dw.dxfReal(40, 0.0);
    } else if (!stricmp(data.name.c_str(), "ACAD_ISO02W100")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "ACAD_ISO03W100")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "ACAD_ISO04W100")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "ACAD_ISO05W100")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "BORDER")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "BORDER2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "BORDERX2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "CENTER")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "CENTER2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "CENTERX2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHDOT")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHDOT2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHDOTX2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHED")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHED2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DASHEDX2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DIVIDE")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DIVIDE2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DIVIDEX2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DOT")) {
        dw.dxfString(3, "Dot . . . . . . . . . . . . . . . . . . . . . .");
        dw.dxfInt(72, 65);
        dw.dxfInt(73, 2);
        dw.dxfReal(40, 6.35);
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DOT2")) {
        ...
        if (version>=VER_R13)
            dw.dxfInt(74, 0);
    } else if (!stricmp(data.name.c_str(), "DOTX2")) {
...
void DL_Dxf::writeBlock(DL_WriterA& dw, const DL_BlockData& data) {
    ...
    //bool paperSpace = !stricmp(name, "*paper_space");
    //!stricmp(name, "*paper_space0");

    if (!stricmp(data.name.c_str(), "*paper_space")) {
        dw.sectionBlockEntry(0x1C);
    } else if (!stricmp(data.name.c_str(), "*model_space")) {
        dw.sectionBlockEntry(0x20);
    } else if (!stricmp(data.name.c_str(), "*paper_space0")) {
...
void DL_Dxf::writeEndBlock(DL_WriterA& dw, const string& name) {
    if (!stricmp(name.c_str(), "*paper_space")) {
        dw.sectionBlockEntryEnd(0x1D);
    } else if (!stricmp(name.c_str(), "*model_space")) {
        dw.sectionBlockEntryEnd(0x21);
    } else if (!stricmp(name.c_str(), "*paper_space0")) {
